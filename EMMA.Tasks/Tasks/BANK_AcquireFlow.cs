...
namespace EMMA.Tasks {
    internal partial class BANK_AcquireFlow {
        ...
        public override void Run() {
            ...
            _FILE_INPUT_BaseRecord.FILE_TYPE = FILE_TYPE_ComboValues.CSV;
            _FILE_INPUT_BaseRecord.FILE_CATEGORY = FILE_CATEGORY_ComboValues.BANK_STATEMENT;
            ...
            foreach (BMED_Record record in _BMED_record_List) {
                ...
                _BANK_MAIN_BaseRecord.TAG1 = Get_BALANCE_DIRECTION(record.Tag1);
