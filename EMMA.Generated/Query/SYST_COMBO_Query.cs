...
namespace EMMA_BE.Generated {
	public class SYST_COMBO_Query(IConfiguration configuration) : QueryBase(configuration) {
		...
		#region Select
		#region SelectAll
		public List<SYST_COMBO_Record> SelectAll(List<SYST_COMBO_Field>? fields = null) {
        ...
        public List<SYST_COMBO_Record> SelectWithSimpleCriteria(SYST_COMBO_NullRecord nullRecord, List<SYST_COMBO_Field>? fields = null) {
            using SqlConnection connection = new(connectionString);
