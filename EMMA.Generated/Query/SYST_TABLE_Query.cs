...
namespace EMMA_BE.Generated {
	public class SYST_TABLE_Query(IConfiguration configuration) : QueryBase(configuration) {
		...
		public List<SYST_TABLE_NullRecord> SelectAll(List<SYST_TABLE_Field>? fields = null) {
			using SqlConnection connection = new(connectionString);

			List<SYST_TABLE_NullRecord> output = [];
			try {
				connection.Open();
        ...
        public List<SYST_TABLE_NullRecord> SelectWithSimpleCriteria(SYST_TABLE_NullRecord nullRecord, List<SYST_TABLE_Field>? fields = null) {
            using SqlConnection connection = new(connectionString);
        ...
        private static SYST_TABLE_NullRecord ReadNullRecord(SqlDataReader reader, List<SYST_TABLE_Field> fields) {
