namespace Generator {
	internal class ComboValues : Program {
        ...
        public static void Generate() {
			const string folder = @"ComboValues\";
			...
			if (Directory.Exists(@"..\..\..\..\EMMA.Generated\ComboValues")) Directory.Delete(@"..\..\..\..\EMMA.Generated\ComboValues", true);
			Directory.Move(@"..\..\..\Generated\ComboValues", @"..\..\..\..\EMMA.Generated\ComboValues");
		}
		...
		private static void ComboElaboration(Combo_Record combo_record) {
			...
			File.WriteAllText(directory + $"{combo_record.NAME}_ComboValues.cs", _Main);
		}
